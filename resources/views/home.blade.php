...
<body class="text-center">
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main role="main" class="inner cover">
            <h1 class="cover-heading">Big page title.</h1>
            <p class="lead">There would be some text here about what this site is and what would happen if you pressed
                the button below. I guess this could be a photography portfolio website or something like that.</p>
            <p class="lead">
                <a href="/album" class="btn btn-lg btn-secondary">See my work</a>
            </p>
        </main>
